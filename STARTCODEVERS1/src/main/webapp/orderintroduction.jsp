                    ...
                    <form action="fc/showTempUser?command=showTempUser" method="post">
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                        <input type="text" pattern="[0-9]{4}" class="form-control" id="floatingzipCode"
                                               name="zipCode" placeholder="" required
                                ...
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                        <input type="text" pattern="[0-9]{8}" class="form-control"
                                               id="floatingPhoneNumber" name="phoneNumber" placeholder="" required
